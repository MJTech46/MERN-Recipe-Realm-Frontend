        ...
        <>
            ...
            <div className="mainNav bg-white hidden md:block">
                <div className="flex justify-between px-8 py-4 text-black items-center">
                    <p className="flex align-middle items-center justify-center text-2xl  font-bold uppercase">Recipe Realm <span><FaDeskpro /></span></p>
            ...
            <div className="mobileMenu md:hidden relative">
                <div className="flex justify-between px-8 py-4 text-black items-center">
                    <p className="text-4xl  font-bold">Recipe Realm</p>
